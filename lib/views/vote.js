...
module.exports = class Home extends Component {
  constructor (id, state, emit) {
    ...
    this.categories = ['progress', 'changemaker', 'campaign']
  ...
  view (state, emit, render) {
    ...
    return html`
      <main class="View-main u-transformTarget">
        ...
        <section class="View-section">
          ${this.categories.indexOf(self.category) === 0 ? html`
            <div class="Space Space--textBlock Space--textBlockFirst">
              <div class="Text Text--center Text--growing">
                <img src="/goalkeepers-logo.png" style="background: none; max-width: 460px;">
                <div style="display: flex; justify-content: center; align-items: center; transform: translateX(-3%);">
                  <svg width="1467" height="425" viewBox="0 0 1467 425" style="width: 160px; height: auto; margin: 0 16px;">
                    <defs>
                  ...
                  <svg width="401" height="215" viewBox="0 0 401 215" style="width: 160px; height: auto; margin: 0 16px;">
              ...
              <div class="Text Text--center" style="margin-top: 40px;">
                <h2 class="Text-h4">We are looking for individuals who</h2>
                <div class="Grid" style="margin-top: 24px;">
                  <span class="Grid-cell Grid-cell--sm1of2">Can show how their youth-focused work directly links to one of the 17 Global Goals.</span>
                  <span class="Grid-cell Grid-cell--sm1of2">Are courageous, action oriented and optimistic advocates for the Goals.</span>
                  <span class="Grid-cell Grid-cell--sm1of2">Have a compelling story that will engage a wider audience and global media.</span>
                  <span class="Grid-cell Grid-cell--sm1of2">Can illustrate the human impact that their work has already had.</span>
                </div>
              </div>
            </div>
          ` : null}
          ...
          ${render(Category, self.category, render, onselect, self.category !== 'progress' ? onback : null)}
        </section>
      </main>
    `

    function onback () {
      self.category = self.categories[self.categories.indexOf(self.category) - 1]
      self.rerender()
    }
    ...
    function onselect (props) {
      ...
      if (self.categories.indexOf(self.category) === self.categories.length - 1) {
...
function criteria (type) {
  switch (type) {
    case 'progress': return html`
      <div class="Text">
        <h2 class="Text-h3 Text-marque Text-marque--red">Progress Award</h2>
        <h3 class="Text-h4" style="margin-top: 24px;">Criteria</h3>
        <p>The Global Goals Progress Award celebrates the achievement of an individual who is supporting progress for the Goals via a science, technology, digital or business led initiative.</p>
    ...
    case 'changemaker': return html`
      <div class="Text">
        <h2 class="Text-h3 Text-marque Text-marque--blue">Changemaker Award</h2>
        <h3 class="Text-h4" style="margin-top: 24px;">Criteria</h3>
        <p>The Global Goals Progress Award celebrates the achievement of an individual who is supporting progress for the Goals via a science, technology, digital or business led initiative.</p>
        <p>For this award specifically, we are looking for individuals who:</p>
        <ul>
    ...
    case 'campaign': return html`
      <div class="Text">
        <h2 class="Text-h3 Text-marque Text-marque--yellow">Campaign Award</h2>
        <h3 class="Text-h4" style="margin-top: 24px;">Criteria</h3>
        <p>The Global Goals Progress Award celebrates the achievement of an individual who is supporting progress for the Goals via a science, technology, digital or business led initiative.</p>
        <p>For this award specifically, we are looking for individuals who:</p>
        <ul>
