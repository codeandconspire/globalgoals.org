      ...
      <main class="View-main u-transformTarget">
        <section class="View-section">
          <div class="Space Space--textBlock Space--textBlockFirst">
            ...
            <svg id="goalkeepers-logo" width="433" height="104" viewBox="0 0 433 104">
                <defs>
              ...
              <h1 class="u-hiddenVisually" style="margin: 0;">Global Goals Awards 2021</h1>
              <p style="margin: 0;">Thank you for being part of the Global Goals Awards 2021 judging panel. There are three categories for which we need your vote – the Progress Award, the Changemaker Award and the Campaign Award.</p>
            </div>
            <div class="Text Text--center Text--full" style="margin-top: 72px;">
              <h2 class="Text-h3">We are looking for young leaders who</h2>
              <div class="Grid" style="margin-top: 48px;">
                <div class="Grid-cell Grid-cell--sm1of2 Grid-cell--md1of4">
                  <div>
                    ...
                    <p>Have achieved success in their work specifically in 2021, during or in response to the COVID-19 pandemic.</p>
                  </div>
                </div>
                <div class="Grid-cell Grid-cell--sm1of2 Grid-cell--md1of4">
                  <div>
