...
module.exports = view('activities', activities, title)

function activities (state, emit) {
  const { activities: { isLoading, total, items } } = state
  ...
  if (!isLoading && (!total || items.length < total)) {
  ...
  return html`
    <main class="View-main u-transformTarget" id="view-main">
      <section class="View-section">
        ...
        ${!isLoading && activities.length ? html`
          <div class="Grid">
            <div class="Grid-cell">
