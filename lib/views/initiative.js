        ...
        <div class="View-article">
          <div class="Text">
            ...
            ${ doc.data.introduction ? html`
              <p class="Text-premable">${ asElement(doc.data.introduction, doc => href(state, doc)) }</p>
            ` : null }
...
function title(state) {
  if (state.initiatives.isLoading) { return html`<span class="u-textLoading">${ __('Loading') }</span>`; }
