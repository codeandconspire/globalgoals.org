  ...
  switch (type) {
    case 'progress': return html`
      <div class="Text">
        ...
        <ul>
          <li>Have had success with work on Good Health and Well-being.</li>
    ...
    case 'changemaker': return html`
      <div class="Text">
        ...
        <p>For this Award specifically, we are looking for individuals who:</p>
        <ul>
          <li>Have had success with work on Gender Equality.</li>
    ...
    case 'campaign': return html`
      <div class="Text">
        ...
        <p class="Text-large">The Global Goals Campaign Award celebrates a campaign lead by a group of people that has raised awareness or built a community in support of a Goal related cause, inspiring action and creating change.</p>
        <p>For this Award specifically, we are looking for a group who:</p>
        <ul>
          <li>Have had success with work on Global Cooperation and Partnerships.</li>
