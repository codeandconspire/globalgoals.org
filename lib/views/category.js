  ...
  switch (type) {
    ...
    case 'changemaker': return html`
      <div class="Text">
        ...
        <ul>
          ...
          <li>Have become a spokesperson for change, gaining a ention for both the challenge and the solution. The individual has shown personal bravery and resilience and in doing so has inspired others.</li>
    ...
    case 'campaign': return html`
      <div class="Text">
        ...
        <p class="Text-large">The Global Goals Campaign Award celebrates a youth-led (individual or group) campaign that has raised awareness or built a community in support of a youth-focused, Goal related cause, inspiring action and creating change.</p>
        <p>For this award specifically, we are looking for groups or individuals who:</p>
        <ul>
          ...
          <li>Used their movement to get the a ention of leaders with the authority to instigate change for the cause in question.</li>
