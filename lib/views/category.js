    ...
    return html`
      <main class="View-main u-transformTarget">
        <section class="View-section">
          ...
          ` : null}
          ${state.params.category === 'summary' ? html`
            <form class="Space Space--start" action="https://docs.google.com/forms/u/1/d/e/1FAIpQLSeBjEcXoh7In41XOxjjRcA0HVn6XAC39ig5Bs1MW3YTxZBzYg/formResponse" method="POST" onsubmit=${onsubmit}>
