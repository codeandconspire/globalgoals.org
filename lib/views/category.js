  ...
  switch (type) {
    ...
    case 'campaign': return html`
      <div class="Text">
        ...
        <p class="Text-large">The Global Goals Campaign Award celebrates an individual or a group of people that have raised awareness or built a community in support of a Goal related cause, inspiring action and creating change.</p>
