      ...
      <main>
        <section class="View-section">
          <div class="View-intro">
            <div class="Text">
              <h1>Initiatives</h1>
              <p class="Text-preamble">Inspiring text about The Global Goals initiatives, projects and organisations.</p>
            </div>
          </div>
          ...
          ${ state.initiatives.items.map(doc => html`
            <article class="Text">
              ...
              <a href="${ resolve(state.routes.initiative, { initiative: doc.uid }) }">View initiative</a>
            </article>
          `) }
        </section>
      </main>
