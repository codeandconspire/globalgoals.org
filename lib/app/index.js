...
const routes = [
  ...
  [ extend('/organisations'), require('../views/call-to-action') ],
  [ extend('/media'), require('../views/call-to-action') ],
  [ extend('/faq'), require('../views/call-to-action') ],
  [ extend('/newsletter'), require('../views/call-to-action') ],
  [ extend('/:goal(\\d{1,2}):slug(-[-\\w]+)?'), require('../views/goal') ],
  [ extend('/:goal(\\d{1,2}):slug(-[-\\w]+)?/organisations'), require('../views/call-to-action') ],
  [ extend('/:goal(\\d{1,2}):slug(-[-\\w]+)?/newsletter'), require('../views/call-to-action') ],
  [ extend('/:goal(\\d{1,2}):slug(-[-\\w]+)?/tips-tricks'), require('../views/call-to-action') ],
  [ extend('/:goal(\\d{1,2}):slug(-[-\\w]+)?/media'), require('../views/call-to-action') ],
