...
router.post('/api/nominate', async ctx => {
  const response = await got('https://docs.google.com/forms/u/1/d/e/1FAIpQLSeLJ0hpC7L48x64m7iyBIrcbtJ4Iu78hIa8poiKn5mLpBjZvg/formResponse', {
    form: true,
    method: 'POST',
...
router.post('/api/vote', async ctx => {
  const response = await got('https://docs.google.com/forms/u/1/d/e/1FAIpQLSeZRxmFKW0Zz33Z1a_Fslzobu0of4QGYrNlpORO_y6jCtvoKg/formResponse', {
    form: true,
    method: 'POST',
    body: ctx.request.body.fields || ctx.request.body
  })
