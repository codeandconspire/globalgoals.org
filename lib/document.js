        ...
        <script>
          ...
          docready(function() {
            window.setTimeout(function(){
              document.querySelectorAll('[class="Shareable-action"]')[0].onclick = function() {
                gtag('event', 'conversion', {'send_to': 'AW-10793109443/cXPbCL2Hn4IDEMOPx5oo'});
              }
              document.querySelectorAll('[class="Shareable-action"]')[1].onclick = function() {
                gtag('event', 'conversion', {'send_to': 'AW-10793109443/cXPbCL2Hn4IDEMOPx5oo'});
              }
              for (i = 0; i < document.querySelectorAll('a[href*="voicesforchange.world"]').length; i++) {
                document.querySelectorAll('a[href*="voicesforchange.world"]')[i].onclick = function() {
