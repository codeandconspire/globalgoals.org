            ...
            ${process.env.NODE_ENV !== 'development' ? `
              ...
              <script>
                window.addEventListener('load',function() {
                  document.querySelectorAll('[href*="https://www.voicesforchange.world"]').forEach(function(button) {
                    button.onclick = function() {
                      gtag('event', 'conversion', {'send_to': 'AW-10793109443/hG1-CMPGrIADEMOPx5oo'})
                    }
                  })
                  document.querySelectorAll('[href*="https://twitter.com"]').forEach(function(main) {
