...
exports.href = function href(state, doc) {
  ...
  switch (doc.type) {
    ...
    case 'home_page': return resolve(routes.home, { referrer });
    case 'resources': return resolve(routes.resources, { referrer });
    case 'landing_page': return resolve(routes[doc.uid], { referrer });
