...
const props = {
  ...
  render(state, adaptive, emit) {
    ...
    if (typeof window !== 'undefined') {
      ...
      this.isAdapting = this.adaptive && y < window.innerHeight;
    }
    ...
    return html`
      <header class="Header ${ state.navigationOpen ? 'is-open' : '' } ${ adaptive ? 'Header--adaptive' : '' }" id="navigation" role="banner">
