        ...
        <div class="Header-bar">
          ...
          <div class="View-section">
            <div class="Header-content js-content" style="${ transforms.content ? `transform: ${ transforms.content }` : '' }">
              ...
              <a class="Header-logo js-logo" style="${ transforms.logo ? `transform: ${ transforms.logo }` : '' }" href="/" rel="home">
                ...
                <ul class="Header-list js-list" style="${ transforms.list ? `transform: ${ transforms.list }` : '' }">
                  ${ links.map(item => item(state)).map(item => html`
                    <li class="Header-item">
                      <a class="Header-button Header-button--link ${ item.isCurrent ? 'is-current' : '' } js-headerLink" target="${ item.external ? '_blank' : null }" href="${ item.href }">
                        ${ __(item.title) }
