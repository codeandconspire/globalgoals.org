...
function animate(elements, scrollY) {
  ...
  const backgroundZ = modulate(scrollY, [0, ANIMATION_SPEED], [BACKGROUND_Z, 1], true);
  const logoZ = modulate(scrollY, [0, ANIMATION_SPEED], [LOGO_Z, 1], true);
  const logoY = modulate(scrollY, [0, ANIMATION_SPEED], [LOGO_Y, 0], true);
  const navZ = modulate(scrollY, [0, ANIMATION_SPEED], [NAV_Z, 1], true);
  const navY = modulate(scrollY, [0, ANIMATION_SPEED], [NAV_Y, 0], true);
