...
const props = {
  ...
  render(state, emit, adaptive) {
    ...
    let y = 0;
    let transforms = this.getTransforms(0);
    let opacity = this.getOpacity(0);
        ...
        <div class="Header-bar">
          ...
          <div class="View-section">
            <div class="Header-content js-content" style="${ transforms.fill ? `transform: ${ transforms.content }` : '' }">
              <a class="Header-logo js-logo" style="${ transforms.fill ? `transform: ${ transforms.logo }` : '' }" tabindex="-1" onclick=${ linkOnClick } href="/" rel="home">
                ${ logo(true) }
              </a>
