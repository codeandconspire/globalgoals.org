        ...
        <div class="Header-bar">
          ...
          <div class="View-section">
            <div class="Header-content js-content" style="${ styles.fill ? `transform: ${ styles.content }` : '' }">
              ...
              <button class="Header-toggle" onclick=${ toggleNavigation } role="button" data-toggle="collapse" data-target="#main-navigation" aria-controls="main-navigation" aria-expanded="${ state.navigationOpen ? 'true' : 'false' }" aria-label="Toggle navigation">
