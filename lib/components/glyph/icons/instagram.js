...
module.exports = function (className) {
  return html`
    <svg viewBox="0 0 504 504" width="504" height="504" class="${className}" role="presentation" aria-hidden="true">
      <defs>
        <path id="instagram-a" d="M0 504h503.8V0H0z" />
      </defs>
      <g fill="none" fill-rule="evenodd">
        <mask id="instagram-b" fill="currentColor">
          <use xlink:href="#a" />
        </mask>
