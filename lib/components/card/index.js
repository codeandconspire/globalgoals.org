...
exports.loadingCard = function (opts = {}) {
  return html`
    <div class="Card">
      ...
      ${ opts.date ? html`
        <span class="Card-meta"><span class="u-textLoading">${ __('LOADING_TEXT_SHORT') }</span></span>
      ` : null }
      <div class="Text">
        <h1 class="Text-h4"><span class="u-textLoading">${ __('LOADING_TEXT_MEDIUM') }</span></h1>
        <p><span class="u-textLoading">${ __('LOADING_TEXT_LONG') }</span></p>
      </div>
      <span class="Card-link u-removePseudo"><span class="u-textLoading">${ __('LOADING_TEXT_MEDIUM') }</span></span>
    </div>
  `;
};
