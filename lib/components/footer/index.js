...
module.exports = function footer(state) {
  ...
  const goals = [];
  for (let i = 0; i < state.goals.total - 1; i += 1) {
    goals.push(i + 1);
  }
            ...
            <ul class="Footer-list">
              ...
              <li class="Footer-item">
                <a class="Footer-blockLink" href="http://codeandconspire.com">
                  <div class="Footer-figure">
                    <!-- Todo: change icon (and remove blend mode) -->
            ...
            <ul class="Footer-list Footer-list--social">
              ...
              <li class="Footer-item">
                <a class="Footer-link" href="https://www.instagram.com/TheGlobalGoals/">
                  <span class="Footer-social" style="background-image:url('/instagram.png')">Instagram</span>
                </a>
              </li>
              <li class="Footer-item">
                <a class="Footer-link" href="https://www.youtube.com/channel/UCRfuAYy7MesZmgOi1Ezy0ng">
                  <span class="Footer-social" style="background-image:url('/youtube.svg')">YouTube</span>
                </a>
              </li>
            </ul>
