      ...
      <nav class="View-section">
        <div class="Footer-content">
          ...
          <div class="Footer-column">
            <h2 class="Footer-title">${__('Navigation')}</h2>
            <ul class="Footer-list">
              ${links.primary.map(item => item(state)).filter(function (item) {
                if (typeof item.inFooter !== 'undefined') return item.inFooter
                return item
              }).map(item => item.external ? null : html`
                <li class="Footer-item"><a class="Footer-link" href="${item.href}">${__(item.title)}</a></li>
              `)}
            </ul>
          </div>
          <div class="Footer-column">
          ...
          <div class="Footer-column Footer-column--sponsors">
            ...
            <ul class="Footer-list">
              ${links.partners.map(item => item(state)).map(item => html`
                <li class="Footer-item"><a class="Footer-link" href="${item.href}">${__(item.title)}</a></li>
              `)}
            </ul>
          </div>
