            ...
            <ul class="Footer-list">
              ...
              <li class="Footer-item">
                <a class="Footer-blockLink" href="https://thenewdivision.world">
                  ...
                  <div class="Footer-blockLinkTarget">Design and communication <em class="Footer-name">The New Division</em></div>
                </a>
              </li>
              <li class="Footer-item">
                <a class="Footer-blockLink" href="http://codeandconspire.com">
                  <div class="Footer-figure">
                    <img class="Footer-figureImg" height="19" src="/code-and-conspire.svg">
                  </div>
