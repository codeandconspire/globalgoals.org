  ...
  return html`
    <div class="Segment" id="segment-${props.id}">
      ...
      <div class="Segment-body">
        <div class="Text">
          ${props.title ? html`<h3 class="Text-h4 Text-h4--alt">${asText(props.title)}</h3>` : null}
...
function image (props, color) {
  ...
  return html`
    <img class="Segment-image ${background(color)}" width="${width}" height="${height}" alt="${alt || ''}" srcset="${srcset}" src="${url}">
  `
}
