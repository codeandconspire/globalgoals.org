...
const CATEGORIES = [{
  key: 'Progress Award',
  color: 'red',
  description: 'The Global Goals Progress Award celebrates the achievement of an individual who is supporting progress for the Goals via a science, technology, digital or business led initiative and who has had success with work on Good Health and Well-being. (16-30)'
}, {
  key: 'Changemaker Award',
  color: 'blue',
  description: 'The Global Goals Changemaker Award celebrates the achievement of an individual who has inspired Goal related change using their personal experience or from a position of leadership and who have had success with work on Gender Equality. (16-30)'
}, {
  key: 'Campaign Award',
  color: 'yellow',
  description: 'The Global Goals Campaign Award celebrates a group or organisation that has raised awareness or built a community in support of a Goal related cause, inspiring action and creating change, and who have had success with work on Global Cooperation and Partnerships. (16-30)'
}]
