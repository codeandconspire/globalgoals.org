      ...
      <form action="https://docs.google.com/forms/u/1/d/e/1FAIpQLSeLJ0hpC7L48x64m7iyBIrcbtJ4Iu78hIa8poiKn5mLpBjZvg/formResponse" method="POST" onsubmit=${onsubmit}>
          ...
          <div class="Grid-cell">
            <div class="Form-field">
              <span class="Form-label">
                Is the individual available to travel to New York for the Awards Ceremony, September 25th 2018?
                <br>
        ...
        <div class="Grid">
          ...
          <div class="Grid-cell">
            <div class="Form-field">
              <label class="Form-pair">
                <input class="Form-toggle" type="checkbox" name="entry.1143045509" value="Yes" onchange=${setProp} required checked=${this.props['entry.1143045509'] === 'Yes'} /> <span class="Form-label">I have read and agree to the <span class="Text"><a href="https://www.globalgoals.org/terms" target="_blank">terms and conditions</a></span></span>
              </label>
            </div>
          </div>
          <div class="Grid-cell">
