...
const CATEGORIES = [{
  key: 'Progress Award',
  color: 'red',
  description: 'The Global Goals Progress Award celebrates the achievement of an individual who is supporting progress for the Goals via a science, technology, digital or business led initiative and who has had success with work on',
  goal: 'Good Health and Well-being'
}, {
  key: 'Changemaker Award',
  color: 'blue',
  description: 'The Global Goals Changemaker Award celebrates the achievement of an individual who has inspired Goal related change using their personal experience or from a position of leadership and who have had success with work on',
  goal: 'Gender Equality'
}, {
  key: 'Campaign Award',
  color: 'yellow',
  description: 'The Global Goals Campaign Award celebrates a group or organisation that has raised awareness or built a community in support of a Goal related cause, inspiring action and creating change, and who have had success with work on',
...
module.exports = class Form extends Component {
  ...
  createElement () {
    ...
    return html`
      <form action="https://docs.google.com/forms/u/1/d/e/1FAIpQLSeBjEcXoh7In41XOxjjRcA0HVn6XAC39ig5Bs1MW3YTxZBzYg/formResponse" method="POST" onsubmit=${onsubmit}>
        ...
        <div class="Text Space Space--end">
          <h2 class="Text-h3">General awards criteria the category</h2>
          <p>For all three awards, winners must:</p>
          <ul>
            <li>Have achieved success in their work specifically in 2020 during or in response to the COVID-19 pandemic.</li>
                ...
                <label class="Form-choice Form-choice--${color} ${this.props['entry.145002520'] === key ? 'is-selected' : ''}">
                  ...
                  <div class="Form-description">
                    <div class="Text Text--full">
                      <p>${description} <strong>${goal}</strong>. ${index === 2 ? '(leading members to be aged between 16-30)' : '(Age 16-30)'}</p>
                    </div>
                  </div>
                </label>
              </div>
        ...
        <div class="Grid">
          ...
          <div class="Grid-cell Grid-cell--md1of2">
            <label class="Form-field">
              <span class="Form-label">Age of nominee or age of leading member</span>
          ...
          <div class="Grid-cell">
            <div class="Form-field">
              <label for="reason" class="Form-label">
                ...
                <br>
                <small class="Form-meta">Please answer referring to <span class="Text"><a href="https://prismic-io.s3.amazonaws.com/globalgoals/f8a035c5-87a2-474c-a745-53537dc2322f_2020-Goalkeepers-Awards-Criteria.pdf" target="_blank">general criteria for Goalkeeper awards</a></span> and specific required evidence for this category.</small>
              </label>
        ...
        <div class="Grid">
          ...
          <div class="Grid-cell">
            <div class="Form-field">
              <label class="Form-pair">
                <input class="Form-toggle" type="checkbox" name="entry.1143045509" value="Yes" onchange=${setProp} required checked=${this.props['entry.1143045509'] === 'Yes'} /> <span class="Form-label">I have read and agree to the <span class="Text"><a href="https://prismic-io.s3.amazonaws.com/globalgoals/4d65856e-e825-4b93-bf73-5f672f81f8fb_29.06+Goalkeepers+Awards+Terms+Conditions_.pdf" target="_blank">terms and conditions</a></span></span>
              </label>
            </div>
          </div>
          <div class="Grid-cell">
