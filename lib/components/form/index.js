    ...
    return html`
      <form action="https://docs.google.com/forms/u/1/d/e/1FAIpQLSeBjEcXoh7In41XOxjjRcA0HVn6XAC39ig5Bs1MW3YTxZBzYg/formResponse" method="POST" onsubmit=${onsubmit}>
        ...
        <div class="Grid">
          ...
          <div class="Grid-cell Grid-cell--md1of2">
            <label class="Form-field">
              <span class="Form-label">Age of nominee <br><small class="Form-meta">On September 24th 2020</small></span>
          ...
          <div class="Grid-cell">
            <div class="Form-field">
              <span class="Form-label">
                Is the individual available to travel to New York for the Awards Ceremony, September 24th 2020?
                <br>
              ...
              <label class="Form-pair">
                <input class="Form-toggle" type="radio" onchange=${setProp} name="entry.380787076" value="Unsure" required checked=${this.props['entry.380787076'] === 'Unsure'} /> <span class="Form-label">Unsure</span>
              </label>
            </div>
          </div>
          <div class="Grid-cell">
            <div class="Form-field">
              <label for="reason" class="Form-label">
                ...
                <br>
                <small class="Form-meta">Please answer referring to <span class="Text"><a href="https://prismic-io.s3.amazonaws.com/globalgoals%2F75733201-45c1-435b-89a7-699c34b610e8_2019+updated+criteria+doc+pdf+.pdf" target="_blank">general criteria for Goalkeeper awards</a></span> and specific required evidence for this category.</small>
              </label>
