      ...
      <form action="https://docs.google.com/forms/u/1/d/e/1FAIpQLSeBjEcXoh7In41XOxjjRcA0HVn6XAC39ig5Bs1MW3YTxZBzYg/formResponse" method="POST" onsubmit=${onsubmit}>
        ...
        <div class="Grid">
          ...
          <div class="Grid-cell">
            <div class="Form-field">
              <label class="Form-pair">
                <input class="Form-toggle" type="checkbox" name="entry.1143045509" value="Yes" onchange=${setProp} required checked=${this.props['entry.1143045509'] === 'Yes'} /> <span class="Form-label">I have read and agree to the <span class="Text"><a href="https://prismic-io.s3.amazonaws.com/globalgoals%2F0ec262e1-6ff2-4ed2-82f2-2b756746e1cb_terms+conditions+final+5042019.pdf" target="_blank">terms and conditions</a></span></span>
              </label>
            </div>
          </div>
          <div class="Grid-cell">
