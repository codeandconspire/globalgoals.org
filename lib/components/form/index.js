  ...
  createElement () {
    ...
    return html`
      <form action="https://docs.google.com/forms/u/1/d/e/1FAIpQLSeLJ0hpC7L48x64m7iyBIrcbtJ4Iu78hIa8poiKn5mLpBjZvg/formResponse" method="POST" onsubmit=${onsubmit}>
        ...
        <div class="Grid">
          <div class="Grid-cell Grid-cell--md1of2">
            <label class="Form-field">
              ...
              <input type="text" name="entry.577983567" value="${this.props['entry.577983567'] || ''}" oninput=${setProp} class="Form-control" required />
            </label>
          </div>
          <div class="Grid-cell Grid-cell--md1of2">
            <label class="Form-field">
              <span class="Form-label">Organisation/company</span>
              <input type="text" name="entry.1174912357" value="${this.props['entry.1174912357'] || ''}" oninput=${setProp} class="Form-control" required />
            </label>
          </div>
          <div class="Grid-cell Grid-cell--md1of2">
            <label class="Form-field">
              <span class="Form-label">Email</span>
              <input type="email" name="entry.1732288032" value="${this.props['entry.1732288032'] || ''}" oninput=${setProp} class="Form-control" required />
            </label>
          </div>
          <div class="Grid-cell Grid-cell--md1of2">
            <label class="Form-field">
              <span class="Form-label">Telephone</span>
              <input type="tel" name="entry.1029329224" value="${this.props['entry.1029329224'] || ''}" oninput=${setProp} class="Form-control" required />
            </label>
          </div>
        </div>
        <div class="Space Space--start Space--endShort">
        ...
        <div class="Grid">
          <div class="Grid-cell Grid-cell--md1of2">
            <label class="Form-field">
              ...
              <input type="text" name="entry.1475500814" value="${this.props['entry.1475500814'] || ''}" oninput=${setProp} class="Form-control" required />
            </label>
          </div>
          <div class="Grid-cell Grid-cell--md1of2">
            <label class="Form-field">
              <span class="Form-label">Organisation/company <small class="Form-meta">(if applicable)</small></span>
              <input type="text" name="entry.1386450870" value="${this.props['entry.1386450870'] || ''}" oninput=${setProp} class="Form-control" />
            </label>
          </div>
          <div class="Grid-cell Grid-cell--md1of2">
            <label class="Form-field">
              <span class="Form-label">Age of nominee <br><small class="Form-meta">On September 25th 2018</small></span>
          ...
          <div class="Grid-cell Grid-cell--md1of2">
            <label class="Form-field">
              ...
              <select name="entry.9046416" required onchange=${setProp} class="Form-control">
          ...
          <div class="Grid-cell Grid-cell--md1of2">
            <label class="Form-field">
              ...
              <input type="text" name="entry.1364261202" value="${this.props['entry.1364261202'] || ''}" oninput=${setProp} class="Form-control" placeholder="please indicate first language" required />
            </label>
          </div>
          <div class="Grid-cell">
            <div class="Form-field">
              <span class="Form-label">
                Is the individual available to travel to New York for the Awards Ceremony, XX September 2018?
                <br>
          ...
          <div class="Grid-cell">
            <div class="Form-field">
              <label for="reason" class="Form-label">
                ...
                <br>
                <small class="Form-meta">Please answer referring to general criteria for Goalkeeper awards and speci c required evidence for this category.</small>
              </label>
              <textarea class="Form-control" rows="8" id="reason" name="entry.1822369347" oninput=${setProp}>${this.props['entry.1822369347']}</textarea>
              <span class="Form-label">
        ...
        <div class="Space Space--start Space--endShort">
          <div class="Text">
            <h2 class="Text-h3">Relevant social media handles for individual or project/campaign</h2>
          </div>
        </div>
        <div class="Grid">
          <div class="Grid-cell Grid-cell--sm1of2">
            <label class="Form-field">
              ...
              <input type="text" name="entry.277484791" value="${this.props['entry.277484791'] || ''}" oninput=${setProp} class="Form-control" />
            </label>
          </div>
          <div class="Grid-cell Grid-cell--sm1of2">
            <label class="Form-field">
              <span class="Form-label">Twitter</span>
              <input type="text" name="entry.611432332" value="${this.props['entry.611432332'] || ''}" oninput=${setProp} class="Form-control" />
            </label>
          </div>
          <div class="Grid-cell Grid-cell--sm1of2">
            <label class="Form-field">
              <span class="Form-label">Google+</span>
              <input type="text" name="entry.1311642787" value="${this.props['entry.1311642787'] || ''}" oninput=${setProp} class="Form-control" />
            </label>
          </div>
          <div class="Grid-cell Grid-cell--sm1of2">
            <label class="Form-field">
              <span class="Form-label">Instagram</span>
              <input type="text" name="entry.1652770541" value="${this.props['entry.1652770541'] || ''}" oninput=${setProp} class="Form-control" />
            </label>
          </div>
          <div class="Grid-cell Grid-cell--sm1of2">
            <label class="Form-field">
              <span class="Form-label">Snapshat</span>
              <input type="text" name="entry.1039775438" value="${this.props['entry.1039775438'] || ''}" oninput=${setProp} class="Form-control" />
            </label>
          </div>
          <div class="Grid-cell Grid-cell--sm1of2">
            <label class="Form-field">
              <span class="Form-label">Youtube</span>
              <input type="text" name="entry.409674468" value="${this.props['entry.409674468'] || ''}" oninput=${setProp} class="Form-control" />
            </label>
          </div>
          <div class="Grid-cell">
            <div class="Form-field">
          ...
          <div class="Grid-cell">
            <div class="Form-field">
              <label class="Form-pair">
                <input class="Form-toggle" type="checkbox" name="entry.1143045509" value="Yes" onchange=${setProp} required checked=${this.props['entry.1143045509'] === 'Yes'} /> <span class="Form-label">I have read and agree to the terms and conditions</span>
              </label>
            </div>
          </div>
          <div class="Grid-cell">
    ...
    function onsubmit (event) {
      ...
      if (!event.target.checkValidity()) {
        ...
        if (self.error) {
          ...
          const params = Object.keys(self.props).map((key) => {
            return `${key}=${self.props[key]}`
          })

          window.fetch(`${event.target.action}?${params.join('&')}`, {
            method: 'POST'
          }).then(function (response) {
            if (!response.status === 200) throw new Error('Could not submit')
