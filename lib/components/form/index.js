      ...
      <form action="https://docs.google.com/forms/u/1/d/e/1FAIpQLScIgISLQXIsS-RxZ-n1yP9GET3IjKmvvtyfZ1rjxRU_Bk9EGQ/formResponse" method="POST" onsubmit=${onsubmit}>
          ...
          <div class="Grid-cell">
            <div class="Form-field">
              <label for="reason" class="Form-label">
                ...
                <br>
                <small class="Form-meta">Please answer referring to the <span class="Text"><a href="https://prismic-io.s3.amazonaws.com/globalgoals/f8a035c5-87a2-474c-a745-53537dc2322f_2020-Goalkeepers-Awards-Criteria.pdf" target="_blank">detailed criteria for the Goalkeeper awards</a></span> and specific required evidence for this category.</small>
              </label>
        ...
        <div class="Grid">
          ...
          <div class="Grid-cell">
            <div class="Form-field">
              <label class="Form-pair">
                <input class="Form-toggle" type="checkbox" name="entry.1143045509" value="Yes" onchange=${setProp} required checked=${this.props['entry.1143045509'] === 'Yes'} /> <span class="Form-label">I have read and agree to the <span class="Text" style="font-size: 1em"><a style="font-size: 1em" href="https://prismic-io.s3.amazonaws.com/globalgoals/4d65856e-e825-4b93-bf73-5f672f81f8fb_29.06+Goalkeepers+Awards+Terms+Conditions_.pdf" target="_blank">terms and conditions</a></span></span>
              </label>
            </div>
          </div>
          <div class="Grid-cell">
