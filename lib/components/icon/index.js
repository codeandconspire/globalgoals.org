...
function draw (number, lines, lang, parent) {
  ...
  return html`
    <svg role="presentational" aria-hidden="true" class="${className('Icon-label', {[`${parent}-iconLabel`]: parent})}" height="${height * 0.92}" viewBox="0 0 200 ${height}" preserveAspectRatio="xMaxYMin">
