  ...
  return html`
    <svg class="Icon-label ${ componentName }-iconLabel" viewBox="0 0 200 ${ viewBoxHeight }">
      <g style="transform: scale(0.94)">
        <text class="Icon-number ${ componentName }-iconNumber" font-size="59.4" x="${ digitPos }" y="32.8" fill="currentColor" text-anchor="middle" alignment-baseline="middle">${ number }</text>
