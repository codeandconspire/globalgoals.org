...
module.exports = component({
  name: 'background-3',
  load (element) {
    element.querySelectorAll('.js-lifeline').forEach(line => {
  ...
  render () {
    return html`
      <div class="Hero-bg Hero3" id="hero-bg-3">
        <svg class="Hero3-lifeline js-lifeline" viewBox="0 0 698 178">
        ...
        <svg class="Hero3-lifeline Hero3-lifeline--wide js-lifeline" viewBox="0 0 1346 178">
