    ...
    function pophearts() {
      ...
      for (let i = 0; i < hearts.length; i += 1) {
        ...
        Object.assign(hearts[i].style, {
          left: `calc(${ center[0] }% ${ i % 2 ? '+' : '-' } ${ Math.random() * (40 - 20) + 20 }px)`,
          top: `calc(${ center[1] }% ${ i % 2 ? '+' : '-' } ${ Math.random() * (40 - 20) + 20 }px)`
        });
        window.setTimeout(() => {
  ...
  render() {
    return html`
      <div class="Hero-background Hero-background--3">
        ...
        <svg class="Hero-lifeline" viewBox="0 0 1346 178" xmlns="http://www.w3.org/2000/svg">
