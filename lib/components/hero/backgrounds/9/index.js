...
module.exports = class Background extends Component {
  ...
  static identity (opts) {
    return `background-9${opts.tight ? '-tight' : ''}`
  }
  ...
  createElement () {
    return html`
      <div class="Hero-bg Hero9 ${this.tight ? 'Hero9--tight' : ''}" id="hero-bg-9">
        <svg class="u-isHidden">
          <symbol viewBox="0 0 186 186" width="186" height="186" id="hero-9-turbine-blades">
          ...
          <symbol viewBox="0 0 18 232" width="18" height="232" id="hero-9-turbine-pole">
            <path d="M.948 231.688L5.903 3.244l6.192-2.48 4.95 230.924" fill="#FFF" fill-rule="evenodd"/>
          </symbol>
        </svg>

        <div>
          <svg viewBox="0 0 50 50" width="50" height="50" class="Hero9-industryCloud Hero9-industryCloud--md Hero9-industryCloud--light"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
          <svg viewBox="0 0 50 50" width="50" height="50" class="Hero9-industryCloud Hero9-industryCloud--sm"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
          <svg viewBox="0 0 50 50" width="50" height="50" class="Hero9-industryCloud Hero9-industryCloud--md"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
          <svg viewBox="0 0 50 50" width="50" height="50" class="Hero9-industryCloud Hero9-industryCloud--lg"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
          <svg viewBox="0 0 141 97" width="141" height="97" class="Hero9-industryCloud Hero9-industryCloud--xl">
          ...
          <svg viewBox="0 0 50 50" width="50" height="50" class="Hero9-industryCloud Hero9-industryCloud--md"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
          <svg viewBox="0 0 50 50" width="50" height="50" class="Hero9-industryCloud Hero9-industryCloud--lg Hero9-industryCloud--light"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
          <svg viewBox="0 0 50 50" width="50" height="50" class="Hero9-industryCloud Hero9-industryCloud--sm"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
        </div>

        <svg class="Hero9-satellite" viewBox="0 0 86 56" width="86" height="56">
        ...
        <svg class="Hero9-tower" viewBox="0 0 62 300" width="62" height="300">
          <g fill="none" fill-rule="evenodd">
        ...
        <div>
          <svg viewBox="0 0 186 325" width="186" height="325" class="Hero9-industryTurbine">
