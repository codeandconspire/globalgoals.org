  ...
  render() {
    return html`
      <div class="Hero-bg Hero10" id="hero-bg-10">
        ...
        <svg class="Hero10-scale" viewBox="0 0 182 133">
          <g fill="#FFF" fill-rule="evenodd">
            <g transform="translate(67)">
              <rect x="21" width="6" height="129" rx="1"/>
              <path d="M1 127h46c.6 0 1 .4 1 1v5H0v-5c0-.6.4-1 1-1z"/>
            </g>
            <g class="Hero10-scaleArm js-scaleArm">
              <path d="M161 13c0 1.7-1.3 3-3 3H24c-1.7 0-3-1.3-3-3s1.3-3 3-3h134c1.7 0 3 1.3 3 3z"/>
              <path class="Hero10-scaleWeight Hero10-scaleWeight--left js-scaleWeight" d="M0 68.2c0-.5 0-1 .2-1.3l21-55 5.6 2c.3-1 .3-2 0-2l21 55c.2 0 .2 0 .2 1 0 12-10.8 22-24 22S0 80 0 68zM6.6 67h34.8L24 21.4 6.6 67zM24 10c.3 0 .7 0 1 .2.5.2.8.4 1 .7.4 0 .6 0 .8 1z" fill-rule="nonzero"/>
              <path class="Hero10-scaleWeight Hero10-scaleWeight--right js-scaleWeight" d="M134 68.2c0-.5 0-1 .2-1.3l21-55 5.6 2c.3-1 .3-2 0-2l21 55c.2 0 .2 0 .2 1 0 12-10.8 22-24 22s-24-10-24-22zm6.6-1.2h34.8L158 21.4 140.6 67zM158 10c.3 0 .7 0 1 .2.5.2.8.4 1 .7.4 0 .6 0 .8 1z" fill-rule="nonzero"/>
            </g>
          </g>
        </svg>
      </div>
