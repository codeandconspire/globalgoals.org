  ...
  render() {
    return html `
      <div class="Hero-bg Hero4" id="hero-bg-4">
        <svg class="Hero4-diagram" viewBox="0 0 243 215">
          <g fill="none" fill-rule="evenodd" stroke="#FFF" stroke-width="2" stroke-linecap="square" stroke-dasharray="4 8">
            <path class="Hero4-plotLine" d="M1 213h522.4"/>
            <path class="Hero4-plotLine" d="M42 204c29.3-69.7 79-104.5 149.2-104.5 70.2 0 120 34.8 149.2 104.5"/>
            <path class="Hero4-plotLine" d="M193 213L53 2"/>
          </g>
        </svg>
