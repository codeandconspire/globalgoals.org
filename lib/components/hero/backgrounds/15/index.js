...
module.exports = component({
  ...
  render() {
    return html`
      <div class="Hero-background Hero-background--15" id="hero-bg-15">
        ...
        <div class="Hero-savannahSky">
          <div>
            <svg class="Hero-bee"><use xlink:href="#hero-bee-symbol" /></svg>
            <svg class="Hero-bee"><use xlink:href="#hero-bee-symbol" /></svg>
          </div>
          <div>
            <svg class="Hero-bird"><use xlink:href="#hero-bird-symbol" /></svg>
            <svg class="Hero-bird"><use xlink:href="#hero-bird-symbol" /></svg>
            <svg class="Hero-bird"><use xlink:href="#hero-bird-symbol" /></svg>
            <svg class="Hero-bird"><use xlink:href="#hero-bird-symbol" /></svg>
          </div>
          <div>
            ...
            <svg viewBox="0 0 141 97" class="Hero-savannahCloud Hero-savannahCloud--xl Hero-savannahCloud--dim">
        ...
        <svg class="Hero-savannah Hero-savannah--left" viewBox="0 0 236 83">
        ...
        <svg class="Hero-savannah Hero-savannah--right" viewBox="0 0 374 193">
          <g fill="#FFF" fill-rule="evenodd">
            <g class="Hero-savannahThing">
