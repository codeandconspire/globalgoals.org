...
module.exports = component({
  ...
  render() {
    return html`
      <div class="Hero-background Hero-background--15">
        <svg class="Hero-symbols">
        ...
        <div class="Hero-savannahSky">
          <div>
            <svg class="Hero-bee"><use href="#hero-bee-symbol" /></svg>
            <svg class="Hero-bee"><use href="#hero-bee-symbol" /></svg>
          </div>
          <div>
            <svg class="Hero-bird"><use href="#hero-bird-symbol" /></svg>
            <svg class="Hero-bird"><use href="#hero-bird-symbol" /></svg>
            <svg class="Hero-bird"><use href="#hero-bird-symbol" /></svg>
            <svg class="Hero-bird"><use href="#hero-bird-symbol" /></svg>
          </div>
          <div>
            <svg viewBox="0 0 50 50" class="Hero-savannahCloud Hero-savannahCloud--sm"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
            <svg viewBox="0 0 50 50" class="Hero-savannahCloud Hero-savannahCloud--md"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
            <svg viewBox="0 0 141 97" class="Hero-savannahCloud Hero-savannahCloud--xl Hero-savannahCloud--dim" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg viewBox="0 0 50 50" class="Hero-savannahCloud Hero-savannahCloud--md"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
            <svg viewBox="0 0 50 50" class="Hero-savannahCloud Hero-savannahCloud--lg Hero-savannahCloud--light"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
            <svg viewBox="0 0 50 50" class="Hero-savannahCloud Hero-savannahCloud--sm Hero-savannahCloud--dark"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
          </div>
        </div>
        <svg class="Hero-savannah Hero-savannah--left" viewBox="0 0 236 83" xmlns="http://www.w3.org/2000/svg">
          <g fill="none" fill-rule="evenodd">
            <path class="Hero-savannahThing" d="M208.03 66.944v18.148h8.17V66.75c10.42-2.047 18.25-10.925 18.9-22.75h.043c0-.27-.003-.542-.01-.818.007-.26.01-.524.01-.788h-.04c-.725-15.08-11.315-38.402-24.02-38.402-12.704 0-22.866 23.323-23.562 38.402h-.03c0 .258.01.515.01.77 0 .282-.01.56-.01.836h.05c.71 12.252 9.45 21.34 20.5 22.944z" fill="#105702"/>
            <path class="Hero-savannahThing" d="M166.305 66.468v16.595h8.58V66.416l12.18-.075c7.885 0 14.28-6.46 14.28-14.43 0-3.83-1.485-7.3-3.895-9.89 4.005-2.33 6.715-6.69 6.715-11.7 0-7.45-5.97-13.49-13.335-13.49-.29 0-.57.03-.855.05C189.27 7.44 181.51 0 172.005 0c-9.965 0-18.04 8.17-18.04 18.252 0 2.853.67 5.545 1.825 7.953-9.03 2.023-15.79 10.158-15.79 19.9 0 11.267 9.03 20.398 20.16 20.398.244 0 2.75-.014 6.145-.035z" fill="#FFF"/>
            <g fill="#FFF">
              <g class="Hero-savannahThing">
        ...
        <svg class="Hero-savannah Hero-savannah--right" viewBox="0 0 374 193" xmlns="http://www.w3.org/2000/svg">
          <g fill="#FFF" fill-rule="evenodd">
            <g class="Hero-savannahThing">
            ...
            <g class="Hero-savannahThing">
              ...
              <path class="Hero-giraffeNeck js-giraffeNeck" d="M304.038 43.845c.372 1.086.636 2.45.782 3.33 1.66-.12 2.618.102 2.618.102s2.412-.972 4.626-.666c2.214.31-1.458 4.83-1.458 4.83l21.923 66.35-16.42 12.04-12.84-70.88h-15.5c.06-3.85 3.66-5.33 3.66-5.33 4.27-3.78 8.09-5.4 10.93-6.06-.17-.82-.36-1.94-.41-2.95-.82-.22-1.42-.96-1.42-1.84 0-1.05.85-1.9 1.91-1.9 1.05 0 1.91.85 1.91 1.91 0 .41-.13.78-.34 1.09z"/>
            </g>
          </g>
        </svg>
      </div>
