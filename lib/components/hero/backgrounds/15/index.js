    ...
    return html`
      <div class="Hero-bg Hero15" id="hero-bg-15">
        <svg class="u-hiddenVisually">
          <symbol viewBox="0 0 40 21" width="40" height="21" id="hero-bee-symbol">
          ...
          <svg viewBox="0 0 54 14" width="54" height="14" id="hero-bird-symbol">
        ...
        <svg class="Hero15-savannah Hero15-savannah--left" viewBox="0 0 236 83" width="236" height="83">
