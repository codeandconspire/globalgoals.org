...
module.exports = class Background extends Component {
  ...
  static identity (opts) {
    return `background-16${opts.tight ? '-tight' : ''}`
  }
  ...
  createElement () {
    return html`
      <div class="Hero-bg Hero16 ${this.tight ? 'Hero16--tight' : ''}" id="hero-bg-16">
        ...
        <div class="Hero16-sky">
          <svg viewBox="0 0 50 50" width="50" height="50" class="Hero16-cloud Hero16-cloud--medium Hero16-cloud--light"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
          <svg viewBox="0 0 50 50" width="50" height="50" class="Hero16-cloud Hero16-cloud--small"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
          <svg viewBox="0 0 50 50" width="50" height="50" class="Hero16-cloud Hero16-cloud--small Hero16-cloud--dark"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
          <svg viewBox="0 0 50 50" width="50" height="50" class="Hero16-cloud Hero16-cloud--medium"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
          <svg viewBox="0 0 50 50" width="50" height="50" class="Hero16-cloud Hero16-cloud--large"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
          <svg viewBox="0 0 50 50" width="50" height="50" class="Hero16-cloud Hero16-cloud--small Hero16-cloud--light"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
          <svg viewBox="0 0 50 50" width="50" height="50" class="Hero16-cloud Hero16-cloud--small Hero16-cloud--dark"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
          <svg viewBox="0 0 50 50" width="50" height="50" class="Hero16-cloud Hero16-cloud--large Hero16-cloud--light"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
          <svg viewBox="0 0 50 50" width="50" height="50" class="Hero16-cloud Hero16-cloud--medium"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
        </div>

        <div class="Hero16-container">
          <div>
            <svg class="Hero16-person Hero16-person--citizen" width="46" height="94"><use xlink:href="#hero16-woman" /></svg>
            <svg class="Hero16-person Hero16-person--citizen" width="46" height="94"><use xlink:href="#hero16-woman" /></svg>
            <svg class="Hero16-person Hero16-person--citizen" width="20" height="50"><use xlink:href="#hero16-man" /></svg>
            <svg class="Hero16-person Hero16-person--citizen" width="46" height="93"><use xlink:href="#hero16-elderly" /></svg>
            <svg class="Hero16-person Hero16-person--citizen" width="30" height="55"><use xlink:href="#hero16-child" /></svg>
            <svg class="Hero16-person Hero16-person--citizen" width="20" height="50"><use xlink:href="#hero16-man" /></svg>
            <svg class="Hero16-person Hero16-person--citizen" width="46" height="94"><use xlink:href="#hero16-woman" /></svg>
            <svg class="Hero16-person Hero16-person--citizen" width="46" height="94"><use xlink:href="#hero16-woman" /></svg>
            <svg class="Hero16-person Hero16-person--citizen" width="20" height="50"><use xlink:href="#hero16-man" /></svg>
          </div>
          <svg class="Hero16-person Hero16-person--judge" width="27" height="43"><use xlink:href="#hero16-judge" /></svg>
          <svg class="Hero16-building Hero16-building--left" width="94" height="145"><use xlink:href="#hero16-building" /></svg>
          <svg class="Hero16-building Hero16-building--right" width="94" height="145"><use xlink:href="#hero16-building" /></svg>
          <svg viewBox="0 0 249 167" width="249" height="167" class="Hero16-institution">
            <g fill="none" fill-rule="evenodd">
