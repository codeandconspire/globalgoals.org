...
module.exports = class Background extends Component {
  ...
  static identity (opts) {
    return `background-7${opts.tight ? '-tight' : ''}`
  }
  ...
  createElement () {
    return html`
      <div class="Hero-bg Hero7 ${this.tight ? 'Hero7--tight' : ''}" id="hero-bg-7">
        <div class="Hero7-dimmer"></div>

        <svg class="u-isHidden">
          <symbol viewBox="0 0 186 186" id="hero-7-turbine-blades">
          ...
          <symbol viewBox="0 0 18 232"  id="hero-7-turbine-pole">
        ...
        <div>
          <svg viewBox="0 0 186 325" width="186" height="325" class="Hero7-energyTurbine">
            <g transform="translate(0 -68)">
              <use class="Hero7-energyBlades" xlink:href="#hero-7-turbine-blades" />
            </g>
