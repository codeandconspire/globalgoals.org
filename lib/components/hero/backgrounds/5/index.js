...
module.exports = class Background extends Component {
  ...
  static identity (opts) {
    return `background-5${opts.tight ? '-tight' : ''}`
  }
  ...
  createElement () {
    return html`
      <div class="Hero-bg Hero5 ${this.tight ? 'Hero5--tight' : ''}" id="hero-bg-5">
        ...
        <div class="Hero5-people">
          <svg class="Hero5-person" viewBox="0 0 61 137" width="61" height="137">
