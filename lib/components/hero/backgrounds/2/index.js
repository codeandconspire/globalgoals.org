    ...
    return html`
      <div class="Hero-background Hero-background--2" id="hero-bg-2">
        <svg class="Hero-field js-field" viewBox="0 0 1440 246">
          ...
          <use x="-568" height="160" y="87" class="Hero-crop Hero-crop--wheat js-crop" href="#hero-wheat" />
          ...
          <use x="-451" height="94" y="152" class="Hero-crop Hero-crop--wheat Hero-crop--dark Hero-crop--sm js-crop" href="#hero-wheat" />
          <use x="-417" height="62" y="184" class="Hero-crop Hero-crop--wheat Hero-crop--dark Hero-crop--xs js-crop" href="#hero-wheat" />
          <use x="-373" height="164" y="83" class="Hero-crop Hero-crop--corn js-crop" href="#hero-corn" />
          ...
          <use x="316" y="189" height="62" class="Hero-crop Hero-crop--wheat Hero-crop--dark Hero-crop--xs js-crop" href="#hero-wheat" />
          ...
          <use x="439" y="148" height="102" class="Hero-crop Hero-crop--wheat js-crop" href="#hero-wheat" />
          <use x="484" y="137" height="118" class="Hero-crop Hero-crop--corn Hero-crop--dark js-crop" href="#hero-corn" />
          <use x="529" y="46" height="205" class="Hero-crop Hero-crop--corn Hero-crop--lg js-crop" href="#hero-corn" />
