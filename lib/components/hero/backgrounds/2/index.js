...
module.exports = class Background extends Nanocomponent {
  ...
  createElement () {
    return html`
      <div class="Hero-bg Hero2 ${this.tight ? 'Hero2--tight' : ''}" id="hero-bg-2">
        <svg class="Hero2-field js-field" viewBox="0 0 1440 246" width="1440" height="246">
          <symbol id="hero-wheat" viewBox="0 0 40 160" width="40" height="160">
          ...
          <symbol id="hero-corn" viewBox="0 0 174 546" width="174" height="546">
          ...
          <symbol id="hero-barley" viewBox="0 0 43 160" width="43" height="160">
          ...
          <symbol id="hero-carrot" viewBox="0 0 23 82" width="23" height="82">
