...
module.exports = component({
  ...
  render() {
    return html`
      <div class="Hero-bg Hero-bg--2" id="hero-bg-2">
        <svg class="Hero-field js-field" viewBox="0 0 1440 246">
          ...
          <use x="-715" height="94" y="152" class="Hero-crop Hero-crop--barley Hero-crop--dark Hero-crop--sm js-crop" xlink:href="#hero-barley" />
          <use x="-660" height="246" y="1" class="Hero-crop Hero-crop--corn Hero-crop--lg js-crop" xlink:href="#hero-corn" />
          <use x="-618" height="94" y="152" class="Hero-crop Hero-crop--corn Hero-crop--dark Hero-crop--sm js-crop" xlink:href="#hero-corn" />
          <use x="-528" height="62" y="184" class="Hero-crop Hero-crop--wheat Hero-crop--dark Hero-crop--xs js-crop" xlink:href="#hero-wheat" />
          <use x="-516" height="243" y="4" class="Hero-crop Hero-crop--barley Hero-crop--lg js-crop" xlink:href="#hero-barley" />
          <use x="-417" height="62" y="184" class="Hero-crop Hero-crop--wheat Hero-crop--dark Hero-crop--xs js-crop" xlink:href="#hero-wheat" />
          <use x="-318" height="108" y="139" class="Hero-crop Hero-crop--wheat js-crop" xlink:href="#hero-wheat" />
          <use x="-278" height="62" y="184" class="Hero-crop Hero-crop--wheat Hero-crop--dark Hero-crop--xs js-crop" xlink:href="#hero-wheat" />

          <use x="144" y="210" height="86" class="Hero-crop Hero-crop--carrot Hero-crop--sm js-crop" xlink:href="#hero-carrot" />
          <use x="184" y="201" height="102"class="Hero-crop Hero-crop--carrot js-crop" xlink:href="#hero-carrot" />
          <use x="218" y="210" height="86" class="Hero-crop Hero-crop--carrot Hero-crop--sm js-crop" xlink:href="#hero-carrot" />

          <use x="355" y="137" height="115" class="Hero-crop Hero-crop--barley Hero-crop--dark Hero-crop--mirror js-crop" xlink:href="#hero-barley" />
          <use x="398" y="179" height="77" class="Hero-crop Hero-crop--wheat Hero-crop--dark Hero-crop--xs js-crop" xlink:href="#hero-wheat" />
          <use x="484" y="137" height="118" class="Hero-crop Hero-crop--corn Hero-crop--dark js-crop" xlink:href="#hero-corn" />
          <use x="590" y="174" height="77" class="Hero-crop Hero-crop--wheat Hero-crop--dark Hero-crop--xs js-crop" xlink:href="#hero-wheat" />
          <use x="614" y="6" height="243" class="Hero-crop Hero-crop--barley Hero-crop--lg js-crop" xlink:href="#hero-barley" />
          <use x="708" y="114" height="133" class="Hero-crop Hero-crop--wheat js-crop" xlink:href="#hero-wheat" />

          <g>
            <use x="-568" height="160" y="117" class="Hero-crop Hero-crop--grow Hero-crop--wheat js-crop" xlink:href="#hero-wheat" />
            <use x="-451" height="94" y="182" class="Hero-crop Hero-crop--grow Hero-crop--wheat Hero-crop--dark Hero-crop--sm js-crop" xlink:href="#hero-wheat" />
            <use x="-373" height="164" y="113" class="Hero-crop Hero-crop--grow Hero-crop--corn js-crop" xlink:href="#hero-corn" />
            <use x="316" y="189" height="92" class="Hero-crop Hero-crop--grow Hero-crop--wheat Hero-crop--dark Hero-crop--xs js-crop" xlink:href="#hero-wheat" />
            <use x="439" y="148" height="132" class="Hero-crop Hero-crop--grow Hero-crop--wheat js-crop" xlink:href="#hero-wheat" />
            <use x="529" y="46" height="235" class="Hero-crop Hero-crop--grow Hero-crop--corn Hero-crop--lg js-crop" xlink:href="#hero-corn" />
          </g>
        </svg>
      </div>
    `;
