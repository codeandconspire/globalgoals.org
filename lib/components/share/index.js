        ...
        <div class="Share-container">
          <div class="Share-body">
            ...
            <ul class="Share-options">
              ...
              <li class="Share-option">
                <a href="https://twitter.com/intent/tweet?url=${ uri }&text=${ encodeURIComponent(props.description) }&${ process.env.GLOBALGOALS_TWITTER_ID ? `via=${ process.env.GLOBALGOALS_TWITTER_ID }` : '' }" class="Share-link">
                  <svg viewBox="0 0 64 64" width="64" height="64" class="Share-icon">
                    <g fill="none" fill-rule="evenodd">
              ...
              <li class="Share-option">
                <a href="http://service.weibo.com/share/share.php?url=${ uri }&appkey=&title=${ encodeURIComponent(props.description) }&pic=&ralateUid=" class="Share-link">
                  <svg viewBox="0 0 64 64" width="64" height="64" class="Share-icon">
                    <g fill="none" fill-rule="evenodd">
