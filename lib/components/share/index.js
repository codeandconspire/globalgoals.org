    ...
    return html`
      <div class="Share" id="share">
        <div class="Share-container">
          <div class="Share-body">
            ...
            <ul class="Share-options">
              <li class="Share-option">
                <a href="${ process.env.GLOBALGOALS_FACEBOOK_ID ? `https://www.facebook.com/dialog/share?app_id=${ process.env.GLOBALGOALS_FACEBOOK_ID }&display=page&href=${ uri }&redirect_uri=${ uri }` : `https://www.facebook.com/sharer.php?u=${ uri }` }" class="Share-link">
              ...
              <li class="Share-option">
                <a href="https://twitter.com/intent/tweet?url=${ uri }&text=${ props.title }&${ process.env.GLOBALGOALS_TWITTER_ID ? `via=${ process.env.GLOBALGOALS_TWITTER_ID }` : '' }&hashtags=${ props.description.split('#').slice(1).map(tag => tag.trim()).join(',') }" class="Share-link">
                  <svg viewBox="0 0 64 64" width="64" height="64" class="Share-icon">
                    <g fill="none" fill-rule="evenodd">
              ...
              <li class="Share-option">
                <a href="http://service.weibo.com/share/share.php?url=${ uri }&appkey=&title=${ props.title }&pic=&ralateUid=" class="Share-link">
                  <svg viewBox="0 0 64 64" width="64" height="64" class="Share-icon">
                    <g fill="none" fill-rule="evenodd">
              ...
              <li class="Share-option">
                <a href="http://vk.com/share.php?url=${ uri }" class="Share-link">
                  <svg viewBox="0 0 64 64" width="64" height="64" class="Share-icon">
                    <g fill="none" fill-rule="evenodd">
              ...
              ${ props.asset ? html`
                <li class="Share-option">
                  <a href="${ props.asset }" class="Share-link" download>
                    <svg viewBox="0 0 64 64" width="64" height="64" class="Share-icon">
                      <g fill="none" fill-rule="evenodd">
          ...
          <a href="/${ props.href }" class="Share-close" onclick=${ close }>
