          ...
          <div class="Share-body">
            ...
            <ul class="Share-options">
              <li class="Share-option">
                <a target="_blank" rel="noopener noreferrer"  href="${ process.env.GLOBALGOALS_FACEBOOK_ID ? `https://www.facebook.com/dialog/share?app_id=${ process.env.GLOBALGOALS_FACEBOOK_ID }&display=page&href=${ uri }&redirect_uri=${ uri }` : `https://www.facebook.com/sharer.php?u=${ uri }` }" class="Share-link">
              ...
              <li class="Share-option">
                <a target="_blank" rel="noopener noreferrer"  href="https://twitter.com/intent/tweet?url=${ uri }&text=${ encodeURIComponent(props.description) }&${ process.env.GLOBALGOALS_TWITTER_ID ? `via=${ process.env.GLOBALGOALS_TWITTER_ID }` : '' }" class="Share-link">
                  <svg viewBox="0 0 64 64" width="64" height="64" class="Share-icon">
                    <g fill="none" fill-rule="evenodd">
