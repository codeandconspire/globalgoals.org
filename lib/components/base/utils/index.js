...
exports.scrollIntoView = (element, options = { behavior: 'smooth', offsetTop: require('../../header').height }) => {
  const rect = element.getBoundingClientRect();
  const amount = rect.top - options.offsetTop;

  window.scroll({ top: amount, left: 0, behavior: options.behavior });
};
