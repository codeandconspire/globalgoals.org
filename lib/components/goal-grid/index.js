...
module.exports = (state, emit) => {
  ...
  function onclick(event, goal) {
    ...
    link.addEventListener('transitionend', function onclickend() {
      ...
      takeover.style.width = `${ box.width }px`;
      takeover.style.height = `${ box.height }px`;
      takeover.style.top = `${ box.top }px`;
      takeover.style.left = `${ box.left }px`;
      ...
      requestAnimationFrame(() => {
        ...
        clone.style.height = `${ icon.height }px`;
        clone.style.width = `${ icon.width }px`;
        clone.style.left = `${ icon.left }px`;
        clone.style.top = `${ icon.top }px`;
        ...
        requestAnimationFrame(() => {
          ...
          /**
           * Transition clone to target location
           */
