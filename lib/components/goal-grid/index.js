  ...
  createElement (doc) {
    ...
    return html`
      <div class="GoalGrid ${state.layout ? 'GoalGrid--layout GoalGrid--layout' + state.layout : ''}" id="${this._name}">
        ...
        ${state.layout && doc.data.grid_slots && doc.data.grid_slots[0] ? largeBanner(doc && doc.data.grid_slots[0]) : null}
        ${state.layout && doc.data.grid_slots && doc.data.grid_slots[1] ? smallBanner(doc && doc.data.grid_slots[1]) : null}
