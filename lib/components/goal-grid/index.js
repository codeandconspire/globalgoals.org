  ...
  render (state, emit, doc) {
    ...
    return html`
      <div class="GoalGrid ${state.layout ? 'GoalGrid--layout' + state.layout : ''}">
        ...
        <a class="GoalGrid-item GoalGrid-item--cta" href="${doc ? url(doc.data.banners[0].link, '#call-to-action') : null}">
              ...
              <div class="GoalGrid-details">
                ${doc ? html`
                  <div class="GoalGrid-desc Text Text--growingLate">
                    ...
                    <p class="GoalGrid-paragraph">${asText(doc.data.banners[0].body)}</p>
                  </div>
                ` : html`
                  <div class="GoalGrid-desc Text Text--growingLate">
        ...
        <a class="${bannerClassName}" href="${doc ? url(doc.data.banners[1].link) : null}">
