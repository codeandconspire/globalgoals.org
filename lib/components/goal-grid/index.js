...
module.exports = component({
  ...
  render(state, emit) {
    ...
    /**
     * Rememebr how many items were availible on last render
     */
    ...
    return html`
      <div class="GoalGrid ${ state.layout ? 'GoalGrid--layout' + state.layout : '' }">
        ...
        <a class="GoalGrid-item GoalGrid-item--banner" href="http://www.globalgoals.org/goalkeepers/" rel="noopener" target="_blank">
          <div class="GoalGrid-bg">
            <div class="GoalGrid-content">
